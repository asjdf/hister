...
func init() {
	...
	importBrowserHistoryCmd.Flags().String("browser", "", "limit autodetection to a supported browser")
	importBrowserHistoryCmd.Flags().String("db", "", "browser history database path")
